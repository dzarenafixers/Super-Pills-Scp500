...
namespace SCP500Expanded.Items
{
    ...
    public class ArcanePill : CustomItem
    {
        public override uint Id { get; set; } = 5009;
        public override string Name { get; set; } = "Arcane Pill";
        public override string Description { get; set; } = "Walk through doors for 10 seconds.";
        ...
        private void OnUse(UsedItemEventArgs ev)
        {
            ...
            ev.Player.EnableEffect(EffectType.Ghostly, 10, true);
            ev.Player.ShowHint("يمكنك المرور عبر الأبواب لمدة 10 ثوانٍ!", 3);
        }
    }
}